...
Please check out [APPENDIX: Data Tidying](#appendix-data-tidying) for a comprehensive example taken from the `Open Music Europe` Work Packages 1, 2, 3 with Excel and Word.
